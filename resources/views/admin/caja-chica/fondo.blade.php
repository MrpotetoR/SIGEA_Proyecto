    ...
    <div class="max-w-6xl space-y-6">
        ...
        <form method="POST" action="{{ route('admin.caja-chica.fondo.update') }}" enctype="multipart/form-data"
            ...
            <div class="border-t dark:border-gray-700 pt-5">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1 inline-flex items-center gap-1.5">
                ...
                <div class="mt-4 bg-gray-50 dark:bg-gray-900/40 rounded-lg p-4 border dark:border-gray-700">
                    ...
                    <p x-show="umbralAmarillo >= umbralVerde" x-cloak class="text-xs text-red-600 dark:text-red-400 mt-2 inline-flex items-center gap-1">
