<x-panel title="Detalle de Carrera" panelNombre="Servicios Escolares">
    ...
    <div class="max-w-4xl space-y-6">
        <a href="{{ route('servicios.carreras.index') }}" class="text-sm text-[#0606F0] dark:text-blue-400 hover:underline inline-block">← Volver</a>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow dark:shadow-gray-900/20 p-6 border border-transparent dark:border-gray-700">
            <div class="flex items-start justify-between mb-4">
                <div>
                    ...
                    <p class="text-sm text-gray-400 dark:text-gray-400 mt-1">Clave: <span class="font-mono font-semibold text-[#0606F0] dark:text-blue-400">{{ $carrera->clave_carrera }}</span></p>
                </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow dark:shadow-gray-900/20 overflow-hidden border border-transparent dark:border-gray-700">
            ...
            @else
                @foreach($carrera->materias->groupBy('cuatrimestre') as $cuatrimestre => $materias)
                    <div class="px-6 py-3 bg-blue-50 dark:bg-blue-900/20 border-b dark:border-gray-700 text-xs font-semibold text-blue-700 dark:text-blue-400 uppercase tracking-wide">
