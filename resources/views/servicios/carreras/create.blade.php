            ...
            <form method="POST" action="{{ route('servicios.carreras.store') }}" class="space-y-5">
                ...
                <div>
                    ...
                    <input type="text" name="nombre_carrera" value="{{ old('nombre_carrera') }}" required
                           class="w-full border rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-400 focus:outline-none dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200 @error('nombre_carrera') border-red-400 @enderror">
                ...
                <div>
                    ...
                    <input type="text" name="clave_carrera" value="{{ old('clave_carrera') }}" required
                           ...
                           class="w-full border rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-400 focus:outline-none dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200 @error('clave_carrera') border-red-400 @enderror">
