<x-panel title="Nueva Materia" panelNombre="Servicios Escolares">
    ...
    <div class="max-w-lg">
        <a href="{{ route('servicios.materias.index') }}" class="text-sm text-indigo-600 dark:text-indigo-400 hover:underline mb-6 inline-block">← Volver</a>
            ...
            <form method="POST" action="{{ route('servicios.materias.store') }}" class="space-y-5">
                ...
                <div>
                    ...
                    <input type="text" name="nombre_materia" value="{{ old('nombre_materia') }}" required
                           class="w-full border rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-indigo-400 focus:outline-none dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200 @error('nombre_materia') border-red-400 @enderror">
                ...
                <div>
                    ...
                    <select name="id_carrera" required class="w-full border rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-indigo-400 focus:outline-none dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <select name="cuatrimestre" required class="w-full border rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-indigo-400 focus:outline-none dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200">
                            @for($i = 1; $i <= 10; $i++)
                ...
                <div class="flex gap-3 pt-4 border-t dark:border-gray-700">
                    <button type="submit" class="bg-indigo-700 hover:bg-indigo-800 dark:bg-indigo-600 dark:hover:bg-indigo-500 text-white px-6 py-2.5 rounded-lg text-sm font-semibold transition-colors">Crear materia</button>
