<x-panel title="Nuevo Personal" panelNombre="Servicios Escolares">
    ...
    <div class="max-w-2xl">
        <a href="{{ route('servicios.personal.index') }}" class="text-sm text-indigo-600 dark:text-indigo-400 hover:underline mb-6 inline-block">← Volver</a>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow dark:shadow-gray-900/20 border border-transparent dark:border-gray-700 p-6">
            ...
            <form method="POST" action="{{ route('servicios.personal.store') }}" class="space-y-5">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-400 dark:text-gray-400 mt-1">Contraseña inicial: <code class="dark:text-gray-300">servicios{{ date('Y') }}</code></p>
                </div>
