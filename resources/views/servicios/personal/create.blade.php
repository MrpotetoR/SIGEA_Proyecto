<x-panel title="Nuevo Personal" panelNombre="Servicios Escolares">
    <x-slot name="nav">@include('partials.servicios-nav')</x-slot>

    <div class="max-w-2xl">
        <a href="{{ route('servicios.personal.index') }}" class="text-sm text-indigo-600 hover:underline mb-6 inline-block">← Volver</a>

        <div class="bg-white rounded-xl shadow p-6">
            <h2 class="text-lg font-semibold text-gray-700 mb-6">Datos del personal</h2>
            <form method="POST" action="{{ route('servicios.personal.store') }}" class="space-y-5">
                @csrf
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-400 mt-1">Contraseña inicial: <code>servicios{{ date('Y') }}</code></p>
                </div>
                <div class="flex gap-3 pt-4 border-t">
                    ...
                    <a href="{{ route('servicios.personal.index') }}"
