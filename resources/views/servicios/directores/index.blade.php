        ...
        <div class="overflow-y-auto flex-1 custom-scrollbar">
            <table class="w-full divide-y divide-gray-200 dark:divide-gray-700 text-sm bg-white dark:bg-gray-800">
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                            ...
                            <td class="px-4 py-3 text-gray-600 dark:text-gray-400">
                                @if($d->carrerasDirigidas->isNotEmpty())
                                    @foreach($d->carrerasDirigidas as $c)
                                        <span
                                            class="inline-block px-2 py-1 rounded-full text-xs font-medium bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-300">{{ $c->nombre_carrera }}</span>
                                    @endforeach
                                @else
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="px-4 py-10 text-center text-gray-400 dark:text-gray-400">No hay
                                directores registrados.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
