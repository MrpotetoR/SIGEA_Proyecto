<x-panel title="Editar Director" panelNombre="Servicios Escolares">
    ...
    <div class="max-w-2xl">
        <a href="{{ route('servicios.directores.show', $director) }}" class="text-sm text-indigo-600 hover:underline mb-6 inline-block">← Volver</a>

        <div class="bg-white rounded-xl shadow p-6">
            <h2 class="text-lg font-semibold text-gray-700 mb-6">Editar director</h2>
