<x-panel title="Nuevo Director de Carrera" panelNombre="Servicios Escolares">
    ...
    <div class="max-w-2xl">
        <a href="{{ route('servicios.directores.index') }}" class="text-sm text-indigo-600 hover:underline mb-6 inline-block">← Volver</a>

        <div class="bg-white rounded-xl shadow p-6">
            <h2 class="text-lg font-semibold text-gray-700 mb-6">Datos del director</h2>
            <form method="POST" action="{{ route('servicios.directores.store') }}" class="space-y-5">
                @csrf
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-400 mt-1">Contraseña inicial: <code>director{{ date('Y') }}</code></p>
                </div>
                <div class="grid grid-cols-2 gap-4">
                    <div>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Carrera a dirigir</label>
