<x-panel title="Nuevo Director de Carrera" panelNombre="Servicios Escolares">
    ...
    <div class="max-w-2xl">
        <a href="{{ route('servicios.directores.index') }}" class="text-sm text-indigo-600 dark:text-indigo-400 hover:underline mb-6 inline-block">← Volver</a>
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <select name="id_carrera"
                                class="w-full border dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-indigo-400 focus:outline-none @error('id_carrera') border-red-400 @enderror">
