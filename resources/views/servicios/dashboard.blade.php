...
<div class="space-y-5">
    ...
    @unless($stats['ciclo_activo'])
        <div class="flex items-center gap-3 bg-amber-50 dark:bg-amber-900/30 border border-amber-200 dark:border-amber-700 rounded-2xl px-5 py-3.5 text-[13px]">
            ...
            <a href="{{ route('servicios.ciclos.create') }}" class="ml-auto text-amber-700 dark:text-amber-300 font-semibold hover:underline">Crear ciclo →</a>
        </div>
    @endunless
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm dark:shadow-gray-900/20 overflow-hidden">
        <div class="grid grid-cols-2 md:grid-cols-4 divide-y md:divide-y-0 md:divide-x divide-gray-100 dark:divide-gray-700">
            ...
            <div class="p-5 card-hover">
                ...
                <a href="{{ route('servicios.alumnos.index', ['estatus' => 'baja_temporal']) }}" class="text-[11px] text-amber-500 dark:text-amber-400 hover:underline mt-1.5 block">Ver bajas →</a>
            </div>
            ...
            <div class="p-5 card-hover">
                <div class="flex items-center gap-2 mb-3">
                    ...
                    <span class="text-[13px] font-semibold text-gray-700 dark:text-gray-300">Carreras</span>
                </div>
                <p class="text-[28px] font-bold text-gray-900 dark:text-gray-100 leading-none">{{ $stats['total_carreras'] }}</p>
                <a href="{{ route('servicios.carreras.index') }}" class="text-[11px] text-sky-500 dark:text-sky-400 hover:underline mt-1.5 block">Ver carreras →</a>
            </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm dark:shadow-gray-900/20 card-hover">
            ...
            <div class="px-5 pb-5 grid grid-cols-2 gap-2">
                ...
                $accesos = [
                    ...
                    ['route' => 'servicios.reportes',        'label' => 'Ver Reportes',
                    ...
                    ['route' => 'servicios.constancias',     'label' => 'Constancias',
                    ...
                    ['route' => 'servicios.inscripciones',   'label' => 'Inscripciones',
