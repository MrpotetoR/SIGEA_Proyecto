            ...
            <tbody class="divide-y divide-gray-100">
                @forelse($ciclos as $ciclo)
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="px-4 py-3 font-bold text-gray-900">{{ $ciclo->nombre }}</td>
                        <td class="px-4 py-3 text-center text-gray-600">{{ $ciclo->fecha_inicio->format('d/m/Y') }}</td>
                        <td class="px-4 py-3 text-center text-gray-600">{{ $ciclo->fecha_fin->format('d/m/Y') }}</td>
                        ...
                        <td class="px-4 py-3 text-center">
                            <div class="flex justify-center gap-2">
                                <a href="{{ route('servicios.ciclos.edit', $ciclo) }}" class="text-yellow-600 hover:text-yellow-900 font-medium">Editar</a>
                ...
                @empty
                    <tr><td colspan="5" class="px-4 py-10 text-center text-gray-400">No hay ciclos escolares.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
