...
<div class="max-w-2xl space-y-5">
    ...
    <form method="POST" action="{{ route('docente.servicio-social.store') }}" class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 space-y-4 dark:bg-gray-800 dark:border-gray-700 dark:shadow-gray-900/20">
        @csrf
