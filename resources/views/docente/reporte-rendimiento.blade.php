...
<div class="space-y-5">
    ...
    <h1 class="text-[22px] font-bold text-gray-900 dark:text-gray-100">Reporte de Rendimiento</h1>
            ...
            <table class="min-w-full divide-y divide-gray-100 dark:divide-gray-700">
                <thead class="bg-gray-50 dark:bg-gray-700/50">
                    <tr>
                        ...
                        <th class="px-5 py-3 text-center text-[11px] font-semibold text-gray-500 dark:text-gray-400 uppercase">Semáforo</th>
                    ...
                    @foreach($reporte as $r)
                        @php
                            ...
                            $semaforoColor = match($semaforo) {
                                ...
                                'amarillo' => 'bg-amber-100 text-amber-600 dark:bg-amber-900/30 dark:text-amber-300',
                                default    => 'bg-emerald-100 text-emerald-600 dark:bg-emerald-900/30 dark:text-emerald-300',
                            };
                        @endphp
                        <tr class="hover:bg-gray-50/50 dark:hover:bg-gray-700/50">
                            ...
                            <td class="px-5 py-3 text-center">
                                <span class="font-bold text-[13px] {{ $aprobado ? 'text-emerald-600 dark:text-emerald-400' : 'text-red-500 dark:text-red-400' }}">
                            ...
                            <td class="px-5 py-3 text-center">
                                <span class="inline-block px-2.5 py-1 rounded-lg text-[11px] font-bold {{ $aprobado ? 'bg-emerald-50 text-emerald-600 dark:bg-emerald-900/30 dark:text-emerald-300' : 'bg-red-50 text-red-500 dark:bg-red-900/30 dark:text-red-400' }}">
    ...
    @elseif(request('grupo'))
        <div class="bg-white dark:bg-gray-800 dark:border-gray-700 dark:shadow-gray-900/20 rounded-2xl border border-gray-100 shadow-sm p-12 text-center">
            <p class="text-[14px] text-gray-400 dark:text-gray-500">Sin datos de calificaciones para este grupo.</p>
        </div>
    @endif
