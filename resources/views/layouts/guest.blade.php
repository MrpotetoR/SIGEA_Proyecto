...
<head>
    ...
    <title>UDEA — Sistema de Gestion Educativa</title>
        ...
        <div class="left-panel">
            ...
            <div class="fade-up">
                <div style="display:flex; align-items:center; gap:10px;">
                    <img src="{{ asset('images/logo-udea-blanco.png') }}" alt="UDEA" class="h-16 w-auto object-contain filter brightness-0 invert opacity-90 ">
                </div>
            </div>
            ...
            <div class="fade-up" style="animation-delay:0.12s;">
                ...
                <h2 style="color:#ffffff; font-size:70px; font-weight:800; line-height:1.12; letter-spacing:-0.025em;">
                    Sistema de<br>Gestión<br>
                    <span
                        style="background: linear-gradient(135deg, rgba(255,255,255,1), rgba(180,210,255,0.8)); -webkit-background-clip:text; -webkit-text-fill-color:transparent;">Academica</span>
                </h2>
            </div>
            ...
            <div class="fade-up" style="animation-delay:0.22s;">
                <p style="color:rgba(255,255,255,0.3); font-size:11px;">
                    &copy; {{ date('Y') }} UDEA — Todos los derechos reservados
                </p>
            </div>
