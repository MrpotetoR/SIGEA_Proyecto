<x-panel title="Editar Personal" panelNombre="Panel Gestor Escolar">
    <x-slot name="nav">@include('partials.gestor-nav')</x-slot>

    <div class="max-w-2xl">
        <a href="{{ route('gestor.personal.show', $personal) }}" class="text-sm text-[#0606F0] dark:text-blue-400 hover:underline mb-6 inline-block">← Volver</a>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow dark:shadow-gray-900/20 border border-transparent dark:border-gray-700 p-6">
            ...
            @endphp
            <form method="POST" action="{{ route('gestor.personal.update', $personal) }}" class="space-y-5">
                @csrf @method('PUT')
                ...
                <div class="flex gap-3 pt-4 border-t dark:border-gray-700">
                    ...
                    <a href="{{ route('gestor.personal.show', $personal) }}"
