<x-panel title="Detalle Docente" panelNombre="Panel Gestor Escolar">
    <x-slot name="nav">@include('partials.gestor-nav')</x-slot>

    @php $docente->loadMissing('documentos', 'carrerasImparte'); @endphp
    <div class="max-w-5xl space-y-6">
        <div class="flex items-center justify-between">
            <a href="{{ route('gestor.docentes.index') }}" class="text-sm text-[#0606F0] dark:text-blue-400 hover:underline">← Volver</a>
            <a href="{{ route('gestor.docentes.edit', $docente) }}"
