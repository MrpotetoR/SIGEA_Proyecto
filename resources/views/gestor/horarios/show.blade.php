<x-panel title="Detalle Horario" panelNombre="Panel Gestor Escolar">
    <x-slot name="nav">
    ...
    <div class="max-w-2xl bg-white dark:bg-gray-800 rounded-2xl shadow-sm dark:shadow-gray-900/20 border border-gray-100 dark:border-gray-700 p-6">
        ...
        <div class="flex gap-3 mt-6 pt-4 border-t border-gray-100 dark:border-gray-700">
            <a href="{{ route('gestor.horarios.edit', $horario->id_horario) }}" class="px-5 py-2 bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400 text-sm font-medium rounded-xl hover:bg-blue-100 dark:hover:bg-blue-900/50 transition-colors">Editar</a>
        </div>
    </div>
</x-panel>
