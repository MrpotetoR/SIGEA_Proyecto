<x-panel title="Documentos Institucionales" panelNombre="Panel Gestor Escolar">
    <x-slot name="nav">@include('partials.gestor-nav')</x-slot>

    <div class="flex justify-end mb-6">
        <a href="{{ route('gestor.documentos.create') }}"
        ...
        <div class="overflow-y-auto flex-1 custom-scrollbar">
            <table class="w-full divide-y divide-gray-200 dark:divide-gray-700 text-sm bg-white dark:bg-gray-800">
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="px-4 py-10 text-center text-gray-400 dark:text-gray-400">No hay
                                documentos publicados.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
