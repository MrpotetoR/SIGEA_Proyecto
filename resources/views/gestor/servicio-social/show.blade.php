<x-panel title="Detalle Servicio Social" panelNombre="Panel Gestor Escolar">
...
<div class="max-w-2xl space-y-5">
    ...
    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 space-y-3 dark:bg-gray-800 dark:border-gray-700 dark:shadow-gray-900/20">
        ...
        <a href="{{ route('gestor.servicio-social.index') }}" class="inline-block text-[12px] text-gray-500 hover:text-gray-700 mt-3 dark:text-gray-400 dark:hover:text-gray-300">&larr; Volver</a>
    </div>
