<x-panel title="Publicar Noticia" panelNombre="Panel Gestor Escolar">
    <x-slot name="nav">@include('partials.gestor-nav')</x-slot>
    <div class="max-w-2xl">
        <a href="{{ route('gestor.noticias.index') }}" class="text-sm text-[#0606F0] dark:text-blue-400 hover:underline mb-6 inline-block">← Volver</a>
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow dark:shadow-gray-900/20 border border-transparent dark:border-gray-700 p-6">
            <form method="POST" action="{{ route('gestor.noticias.store') }}" enctype="multipart/form-data" class="space-y-5">
                @csrf
                <div>
                ...
                <div x-data="{ archivo: null }">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" name="pdf_nombre" value="{{ old('pdf_nombre') }}" maxlength="150"
                    ...
                    <p class="text-[10px] text-gray-400 mt-1">PDF de hasta 10 MB. Útil para reglamentos, calendarios u oficios oficiales.</p>
