<x-panel title="Editar Grupo" panelNombre="Panel Gestor Escolar">
    <x-slot name="nav">
    ...
    <div class="max-w-2xl bg-white dark:bg-gray-800 rounded-2xl shadow-sm dark:shadow-gray-900/20 border border-gray-100 dark:border-gray-700 p-6">
        <h3 class="text-[15px] font-semibold text-gray-800 dark:text-gray-200 mb-5">Editar Grupo: {{ $grupo->clave_grupo }}</h3>
        ...
        <form method="POST" action="{{ route('gestor.grupos.update', $grupo->id_grupo) }}" class="space-y-5">
            @csrf @method('PUT')
            <div>
