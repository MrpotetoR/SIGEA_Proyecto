<x-panel title="Grupos" panelNombre="Panel Gestor Escolar">
    <x-slot name="nav">
    ...
    <div class="flex items-center justify-between mb-6">
        ...
        <a href="{{ route('gestor.grupos.create') }}" class="inline-flex items-center gap-2 px-4 py-2 bg-[#0606F0] text-white text-sm font-medium rounded-xl hover:bg-[#04276B] transition-colors">
