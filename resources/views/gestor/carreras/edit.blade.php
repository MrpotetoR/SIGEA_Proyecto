<x-panel title="Editar Carrera" panelNombre="Panel Gestor Escolar">
    ...
    <div class="max-w-2xl">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow dark:shadow-gray-900/20 p-6 border border-transparent dark:border-gray-700">
            <form method="POST" action="{{ route('gestor.carreras.update', $carrera) }}" class="space-y-5">
                @csrf @method('PUT')
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="rvoe" value="{{ old('rvoe', $carrera->rvoe) }}" maxlength="50"
                               pattern="[A-Za-z0-9\-/]+"
                        ...
                        <p class="text-[10px] text-gray-400 mt-1">Clave oficial de autorización ante la SEP.</p>
