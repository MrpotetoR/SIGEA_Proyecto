            ...
            @foreach($grupos as $grupo)
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm dark:shadow-gray-900/20 border border-gray-100 dark:border-gray-700 p-5 hover:shadow-md transition-shadow">
                    <div class="flex items-center justify-between mb-3">
                        ...
                        <span class="px-2.5 py-0.5 bg-indigo-50 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-400 text-xs font-medium rounded-lg">{{ $grupo->cuatrimestre }}o Cuat.</span>
                    </div>
                    ...
                    <div class="flex items-center gap-2">
                        <a href="{{ route('director.grupos.show', $grupo->id_grupo) }}" class="flex-1 text-center px-3 py-1.5 bg-gray-50 dark:bg-gray-700/50 text-gray-700 dark:text-gray-300 text-xs font-medium rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">Ver</a>
                        <a href="{{ route('director.grupos.edit', $grupo->id_grupo) }}" class="flex-1 text-center px-3 py-1.5 bg-indigo-50 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-400 text-xs font-medium rounded-lg hover:bg-indigo-100 dark:hover:bg-indigo-900/50 transition-colors">Editar</a>
