...
class ConstanciasController extends Controller
{
    ...
    {
        return view('gestor.constancias.index');
    }
    ...
    public function store(Request $request)
    {
        ...
        $nombre = "constancia_{$alumno->id_alumno_publico}_{$request->tipo}.pdf";
    ...
    public function pdf(Constancia $constancia)
    {
        ...
        $nombre = "constancia_{$constancia->alumno->id_alumno_publico}_{$constancia->tipo}.pdf";
