...
class HorariosController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('gestor.horarios.index', compact('carrera', 'horarios', 'grupos', 'docentes') + ['director' => null]);
    }
    ...
    public function create()
    {
        ...
        return view('gestor.horarios.create', compact('grupos', 'materias', 'docentes'));
    }
    ...
    public function show(Horario $horario) { return view('gestor.horarios.show', compact('horario')); }
    public function edit(Horario $horario)
    {
        $grupos = Grupo::with('carrera')->orderBy('clave_grupo')->get();
        $materias = Materia::orderBy('nombre_materia')->get();
        $docentes = Docente::orderBy('apellidos')->get();
        return view('gestor.horarios.edit', compact('horario', 'grupos', 'materias', 'docentes'));
    }
    ...
    public function update(Request $request, Horario $horario)
    {
        ...
        return redirect()->route('gestor.horarios.index')->with('success', 'Horario actualizado.');
    }

    public function destroy(Horario $horario)
    {
        $horario->delete();
        return redirect()->route('gestor.horarios.index')->with('success', 'Horario eliminado.');
    }
}
