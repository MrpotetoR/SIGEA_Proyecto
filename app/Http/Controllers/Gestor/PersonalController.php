...
class PersonalController extends Controller
{
    ...
    {
        $personal = User::role('gestor_escolar')
        ...
        return view('gestor.personal.index', compact('personal'));
    }

    public function create()
    {
        return view('gestor.personal.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('gestor.personal.index')->with('success', 'Personal registrado.');
    }

    public function show(User $personal)
    {
        return view('gestor.personal.show', compact('personal'));
    }

    public function edit(User $personal)
    {
        return view('gestor.personal.edit', compact('personal'));
    }
    ...
    public function update(Request $request, User $personal)
    {
        ...
        return redirect()->route('gestor.personal.index')->with('success', 'Personal actualizado.');
    }

    public function destroy(User $personal)
    {
        $personal->update(['activo' => false]);
        return redirect()->route('gestor.personal.index')->with('success', 'Personal desactivado.');
    }
}
